...
char STATE[6] = "AAASSS"; // example: +100180 -> velocidad 100 adelante, rotar 180 grados
...
int main(void)
{
  ...
  while (true)
  {
    ...
    uint8_t speed = adc_read(1);
    speed = 100 - speed;
    uint8_t angle = adc_read(0);

    sprintf(STATE, "%03d%03d", angle, speed);
